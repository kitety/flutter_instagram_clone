...
abstract class AppLocalizations {
  ...
  /// Text shown in app bar in users all posts screen
  ///
  /// In en, this message translates to:
  /// **'Posts'**
  ...
  /// Text shown on sponsored post telling that this action will navigate user to authors instagram profile
  ///
  /// In en, this message translates to:
  ...
  ///
  /// In en, this message translates to:
  /// **'Youve seen all new posts from the past 3 days.'**
  ...
  ///
  /// In en, this message translates to:
  /// **'Help people discover your account by using the name yorre known by: either your full name, nickname, or business name.\n\nYou can only change your name twice within 14 days.'**
  String get fullNameEditDescription;

  /// No description provided for @usernameEditDescription.
  ///
  /// In en, this message translates to:
  /// **'Youll be able to change your username back to {username} for another 14 days'**
